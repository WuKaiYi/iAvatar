...
//public class iAvarar_pose3D : MonoBehaviour
//{
...
//    [SerializeField] public MediaPipe.HandLandmark.ResourceSet handLandmarkResource;
//    [SerializeField] HandLandmarkDetector handLandmarkDetector;
...
//    public MediaPipe.HandLandmark.ResourceSet hand;
//    public avatarposmarke avatarposmarke;
//    public VNectBarracudaRunner barracudaRunner;
//    public VNectBarracudaRunner_w barracudaRunner_w;
...
//        detecter = new BlazePoseDetecter(poseLandmarkModel);

//        barracudaRunner.InitVNectModel(barracudaRunner.VNectModel, new ConfigurationSetting());

//        if (handLandmarkResource != null)
//        {
//            handLandmarkDetector = new HandLandmarkDetector(handLandmarkResource);
//        }
//    }
...
//    {
//        float4[] debugpose;
//        debugpose = new float4[detecter.vertexCount];
//        detecter.worldLandmarkBuffer.GetData(debugpose);
//        // avatarposmarke.poseLandmark(debugpose);
//      //  barracudaRunner_w.PredictPose(debugpose);
//     //   barracudaRunner.PredictPose(debugpose);
//        float4[] debugpose_h;
//    //    debugpose_h = new float4[handLandmarkDetector.Handedness];
//   //     if (handLandmarkResource != null)
//   //     {
//   //         handLandmarkDetector.OutputBuffer.GetData(debugpose_h);
//   //     }
