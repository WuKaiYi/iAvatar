...
public class HighlightSelection : MonoBehaviour
{
    ...
    public string TagMask = "CustomTool";
    ...
    public event OnObjectHighlightEvent OnObjectHighlightStart, Hover;
    public event OnObjectHighlightEvent OnObjectHighlightEnd, UnHover;
    public static int lastTriggerTime;

    static HighlightSelection _instance;
    public static HighlightSelection instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<HighlightSelection>();
            }
            return _instance;
        }
    }
    ...
    void SwitchesCollider(Transform newObject)
    {
        ...
        {
            if (UnHover != null && currentEffect.target != null)
            {
                UnHover(currentEffect.target.gameObject);
            }
            if (highlightOnHover)
            {
                Highlight(false);
