...
namespace EasyBuildSystem.Packages.Addons.BuildingMenu
{
    ...
    public class CustonUIBuildingMenu : MonoBehaviour
    {
        #region Fields

        [Serializable]
        public class CustonBuildingMenuCategory
        {
        ...
        [SerializeField] CustonBuildingMenuCategory[] m_Categories;
        ...
        [SerializeField] CustonUIBuildingMenuButton m_UIBuildingSlot;
        ...
        public void ChangeCategory(int index)
        {
            ...
            {
                CustonUIBuildingMenuButton instancedSlot = Instantiate(m_UIBuildingSlot, m_UIBuildingContainer);
                instancedSlot.gameObject.SetActive(true);
                instancedSlot.SetSlot(m_Categories[m_CategoryIndex].Items[i]);

                CustonUIBuildingMenu.CustonBuildingMenuCategory.Item item = m_Categories[m_CategoryIndex].Items[i];
